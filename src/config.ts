...
export const HOME_PAGE: HomePageConfig = {
	...
	lead:
		'No sleepy meetings. We prototype, test, break, fix, and demo in public. Every week is hands-on. Every member builds.',
...
export const ABOUT_PAGE: GenericPageConfig = {
	...
	lead:
		'CodeChaos is a student-led coding community focused on practical execution. We build projects, review each other, and ship regularly.',
};
...
export const EVENTS_PAGE: GenericPageConfig = {
	...
	lead:
		'Every event is designed to produce code output, stronger teamwork, and better engineering habits.',
};
...
export const EVENT_CADENCE = {
	left: ['Monday: Challenge briefing', 'Wednesday: Team build lab', 'Friday: Demo and review'],
	right: ['Monthly: Open showcase', 'Quarterly: Internal hackday', 'Semester: Project expo'],
};
...
export const JOIN_PAGE: GenericPageConfig = {
	...
	lead:
		'We are currently using direct onboarding links and orientation sessions. Fill-in forms will return later with additional automation.',
};
